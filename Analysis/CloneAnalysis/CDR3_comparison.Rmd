...
pheatmap(cur_mat, 
         color = c("grey", colorRampPalette(c("white", "blue", "red"))(909)),
         cluster_cols = FALSE, cluster_rows = FALSE, 
         breaks = seq(0, max(cur_mat), length.out = 1000), cellheight = 8, 
         fontsize = 7)
dev.off()
```
...
pdf("/Users/nils/Dropbox (Cambridge University)/GammaDelta/Analysis/Figures/Vg4_TRG_CDR3.pdf", 
    onefile = FALSE, width = 10, height = 10)
pheatmap(cur_mat, 
         color = c("grey", colorRampPalette(c("white", "blue", "red"))(999)),
         cluster_cols = FALSE, cluster_rows = FALSE, 
         breaks = seq(0, max(cur_mat), length.out = 1000), cellheight = 8, 
         fontsize = 7)
dev.off()
...
pdf("/Users/nils/Dropbox (Cambridge University)/GammaDelta/Analysis/Figures/Vg6_TRG_CDR3.pdf", 
    onefile = FALSE, width = 10, height = 5)
pheatmap(cur_mat, 
         color = c("grey", colorRampPalette(c("white", "blue", "red"))(999)),
         cluster_cols = FALSE, cluster_rows = FALSE, 
         breaks = seq(0, max(cur_mat), length.out = 1000), cellheight = 8, 
...
pdf("/Users/nils/Dropbox (Cambridge University)/GammaDelta/Analysis/Figures/Vg4_TRD_CDR3.pdf", 
    onefile = FALSE, width = 10, height = 20)
pheatmap(cur_mat, 
         color = c("grey", colorRampPalette(c("white", "blue", "red"))(999)),
         cluster_cols = FALSE, cluster_rows = FALSE, 
         breaks = seq(0, max(cur_mat), length.out = 1000), cellheight = 8, 
