...
library(pheatmap)
library(viridis)
data.all <- read.table("../Data/GammaDelta_all.txt", sep = "\t", header = TRUE)

meta <- read.csv("../Data/Metadata.csv", stringsAsFactors = FALSE)
meta <- meta[1:48,]

marker <- read.csv("../Data/Genelist.csv", stringsAsFactors = FALSE)
...
write.table(data.all, "../Data/FilteredCounts.txt", sep = "\t")
```
...
write.table(norm, "../Data/NormCounts.txt", sep = "\t")
```
